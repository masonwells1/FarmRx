...
test('Soil Rx report guide rejects referral, field-binding, and unit mutations', () => {
  ...
  const mutations: Array<[string, string]> = [
    ['remove agronomist referral', source.replace('Ask your Crop RX agronomist for recommendations specific to your farm.', '')],

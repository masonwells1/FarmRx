...
**Last verified publication snapshot (2026-08-03):** PR #19 exact head `bbc5936d52c3fc1293b7306a34b67f9661395d72` merged as `5485374f339931c20fbb1da898e58fa471877ed3` at `2026-08-03T17:12:18Z`. GitHub deployment `5730476422` reported Production success, Vercel deployment `dpl_AG89WXqbHUmqcywNhW2H2BH7Pj5Y` was `READY`, and the canonical root, recovery root, and recovery `/update-password` each returned HTTP `200`. This is dated evidence, not a self-updating claim about the repository or deployment that exists when this file is later read; reverify GitHub and Vercel before describing any SHA or deployment as current.

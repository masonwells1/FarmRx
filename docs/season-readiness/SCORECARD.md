...
**Snapshot:** static hardening and accepted Prairie Spray runtime through `codex/farmrx-2027-season-ready` commit `0753c5165116c6a8f25076dd4b036b9afb570d51` (`0753c51`); accepted continuous Maple Ridge runtime evidence now runs January through July at `021b5875dc6d96ddc1b018f672a204ce1066ec9b` (`021b587`)
...
| Exact-current-HEAD verification ladder | **RUNTIME-BLOCKED** | The accepted continuous Maple Ridge runtime commit is `021b5875dc6d96ddc1b018f672a204ce1066ec9b` through July; PS has separate accepted runtime at `0753c5165116c6a8f25076dd4b036b9afb570d51`, and HR has separate accepted runtime at `a39b4cd4cf6a7bb8b03ba7dd1ee4c8dce98a4fec`. These governed-scenario passes do not create an August–December continuous Maple packet, a full-year packet, or an exact-current-HEAD release claim. |
...
| July | **PROVEN** | SR-017/SR-018; exact commit `021b587` ran continuously from January through the accepted June boundary, then used the governed disposable database clock at `2027-07-09 21:10:00+00:00`. Desktop saved one exact scouting note and one separate manual task with visible receipts; exact SQL/non-write assertions and a 390-by-844 read-only zero-mutation/no-overflow lane passed. | Build and run August continuously from this accepted boundary; the eventual full-year proof must still reset once at January. |
...
| Playwright desktop + phone, Maple August–December | **RUNTIME-BLOCKED** | Continuous executable lanes and accepted runtime evidence remain absent. August is the next required month from the accepted July boundary. |

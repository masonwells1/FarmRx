...
**Snapshot:** fresh-context Sol accepted the local combined Maple Ridge, North Fork, and Pine Hill integration at exact commit `e7efe9a6bc02bbdf603735d8f23ed977ec6d5279` (`e7efe9a`); Prairie Spray and Harvest Ridge remain separately proven at their identified SHAs; Cedar Creek is the next product-blocked lane
...
| Exact-current-HEAD release ladder | **RUNTIME-BLOCKED** | Prairie Spray remains separately proven at `0753c5165116c6a8f25076dd4b036b9afb570d51`, Harvest Ridge at `a39b4cd4cf6a7bb8b03ba7dd1ee4c8dce98a4fec`, and Cedar Creek is **PRODUCT-BLOCKED** with no accepted runtime packet. Those facts prevent an exact-current-HEAD **RELEASE CANDIDATE READY** claim. |
...
| CC — Cedar Creek weather/scouting | **PRODUCT-BLOCKED** | The deterministic contract and earlier Scouting receipt/recovery repair remain accepted, but the 2026-07-29 read-only audit found five existing trust defects: spray success can misstate queued/confirmed state, a successful spray can be submitted again, weather cache age can render negative, Weather read/refresh can write a notification, and the selected Spray tab is not visibly identified. No accepted CC runtime packet exists. Weather-to-spray must remain manual transcription. |
...
| Playwright desktop + phone, CC | **PRODUCT-BLOCKED** | Executable proof must wait for the five bounded trust defects above to be repaired and accepted. No current browser packet may be credited. |

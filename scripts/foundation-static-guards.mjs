...
export function foundationStaticGuard(root = process.cwd()) {
  ...
  requireText(errors, read(root, 'src/auth/AuthProvider.tsx'), 'persistedPasswordRecoveryCleanupAuthority(d.storage, cleanupUserId, d.now()) !== authority', 'auth:completion-revalidates-persisted-lineage-in-transaction')

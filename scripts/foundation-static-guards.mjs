...
export function foundationStaticGuard(root = process.cwd()) {
  ...
  requireText(errors, main, "![passwordRecoveryHostname, 'recovery.localhost'].includes(window.location.hostname)", 'service-worker:recovery-origin-registration-denied')

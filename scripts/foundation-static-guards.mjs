...
export function foundationStaticGuard(root = process.cwd()) {
  ...
  requireText(errors, passwordRecovery, "new URL(passwordRecoveryOrigin)", 'auth:production-recovery-redirect')
  ...
  requireText(errors, app, "void signOut()", 'auth:completion-clears-canonical-session')
  requireText(errors, app, "href={recoveryCompleteUrl}", 'auth:completion-link-signals-canonical-cleanup')

...
& $module {
  ...
  $cedar=Assert-HrClockPhaseInput 'http://127.0.0.1:55321' 'sb_publishable_test' 'synthetic-token' '27010000-0000-4000-8000-000000000005' 'Cedar Creek' '2027-07-07 18:20:00+00:00'
  if($cedar.ToString('o')-notmatch'^2027-07-07T18:20:00'){throw 'HARVEST_RIDGE_CLOCK_PS5_REGRESSION_FAILED: Cedar Creek synthetic proof identity was not accepted.'}
  try{Assert-HrClockPhaseInput 'http://127.0.0.1:55321' 'sb_publishable_test' 'synthetic-token' '27010000-0000-4000-8000-000000000005' 'Cedar Ridge' '2027-07-07 18:20:00+00:00'|Out-Null;throw 'HARVEST_RIDGE_CLOCK_PS5_REGRESSION_FAILED: mismatched Cedar proof identity was accepted.'}catch{if($_.Exception.Message-notmatch'HARVEST_RIDGE_CLOCK_REFUSED'){throw}}
  try{Assert-HrClockPhaseInput 'http://127.0.0.1:55321' 'sb_publishable_test' 'synthetic-token' '27010000-0000-4000-8000-000000000009' 'Cedar Creek' '2027-07-07 18:20:00+00:00'|Out-Null;throw 'HARVEST_RIDGE_CLOCK_PS5_REGRESSION_FAILED: unknown proof identity was accepted.'}catch{if($_.Exception.Message-notmatch'HARVEST_RIDGE_CLOCK_REFUSED'){throw}}

...
function New-MapleSyntheticDockerTopologyPlan {
  ...
  [pscustomobject]@{
    ...
    Images=[ordered]@{
      SupabasePostgres=[ordered]@{Ref='public.ecr.aws/supabase/postgres@sha256:ba10e934f0a59990379f78ab9ed93926f1c291dd61a12fe4026f4202f1b89770';ExpectedLocalImageId='sha256:ba10e934f0a59990379f78ab9ed93926f1c291dd61a12fe4026f4202f1b89770';RequireLocalIdEqualsDigest=$true;PullAllowed=$false}
      ...
      FaketimeArtifacts=[ordered]@{Ref='maple-faketime-artifacts-b9ad08aeb66ed961e8426b2cce527365@sha256:7cbc0a183ba33c4318a9784dae376104e55282e8e0c716511336afaf924f3302';ExpectedLocalImageId='sha256:7cbc0a183ba33c4318a9784dae376104e55282e8e0c716511336afaf924f3302';RequireLocalIdEqualsDigest=$true;PullAllowed=$false;Observed=$true;LabelsVerified=$true}

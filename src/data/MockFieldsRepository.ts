...
const seedFields: Field[] = fieldSeed.map(([name, entityNumber, total_acres, county, state], index) => ({
  ...
  soil_productivity_index: [132.4, 126.8, 119.5, 123.1, 117.9, 129.2, 121.6, 128.7, 124.3, 130.1][index], latitude: null, longitude: null, location_source: null, is_active: true, created_at: farm.created_at, updated_at: farm.updated_at,
}))

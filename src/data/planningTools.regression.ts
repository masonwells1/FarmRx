...
const budget = (id: string, name: string, yieldPerAcre: number, price: number): CropBudget => ({ id, farm_id: 'farm', crop_year: 2026, commodity_id: 'corn', operating_entity_id: null, enterprise_label: null, name, expected_yield_per_acre: yieldPerAcre, expected_price_per_bushel: price, rp_coverage_pct: null, rp_aph_yield: null, rp_projected_price: null, rp_premium_per_acre: null, copied_from_budget_id: null, created_at: at, updated_at: at })

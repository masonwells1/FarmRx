...
const tabAlignmentStart = inventoryModule.indexOf('useLayoutEffect(() => {\n    const tabList = tabListRef.current')
const tabAlignmentEnd = inventoryModule.indexOf('\n  }, [view, workspaceReady])', tabAlignmentStart)
assert.ok(tabAlignmentStart >= 0 && tabAlignmentEnd > tabAlignmentStart, 'The bounded Inventory tab-alignment effect must remain independently identifiable.')
const tabAlignmentEffect = inventoryModule.slice(tabAlignmentStart, tabAlignmentEnd)

...
export type ExpectedWriteVersion = { expected_updated_at?: string | null }
export type EquipmentWrite = Omit<Equipment, 'created_by' | 'created_at' | 'updated_at'> & ExpectedWriteVersion
export type MeterReadingWrite = Omit<MeterReading, 'farm_id' | 'created_by' | 'created_at' | 'updated_at'>
export type IntervalWrite = Omit<ServiceInterval, 'farm_id' | 'created_by' | 'created_at' | 'updated_at'> & ExpectedWriteVersion

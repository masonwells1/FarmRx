...
import { addMonthsClamped, shiftWallClock, todayNextUp, todayRecordTiles, todaySprayWindow } from './today'
...
const slightlyOver = todayNextUp({ profile: owner, today, equipment: { ...workspace, service_due: [{ farm_id: farmA, equipment_id: tractor.id, interval_id: oil.id, reason: 'meter', overdue_amount: 0.25 }], tasks: [] }, notifications: [] })
...
const bothRules = todayNextUp({ profile: owner, today, equipment: { ...workspace, service_due: [{ farm_id: farmA, equipment_id: tractor.id, interval_id: oil.id, reason: 'calendar', overdue_amount: 3 }, { farm_id: farmA, equipment_id: tractor.id, interval_id: oil.id, reason: 'meter', overdue_amount: 12 }], tasks: [] }, notifications: [] })
...
const calendarOnlyLate = todayNextUp({ profile: owner, today, equipment: { ...workspace, service_due: [{ farm_id: farmA, equipment_id: tractor.id, interval_id: oil.id, reason: 'meter', overdue_amount: 0 }, { farm_id: farmA, equipment_id: tractor.id, interval_id: oil.id, reason: 'calendar', overdue_amount: 2 }], tasks: [] }, notifications: [] })

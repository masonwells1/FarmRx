...
const grainWorkspace: GrainWorkspace = {
  ...
  grain_contract_deliveries: [], insurance_units: [], grain_bins: [], bin_inventory: [], bin_transactions: [], usda_market_reports: [], usda_report_dates: [], marketing_alert_rules: [], firm_offers: [], grain_alert_settings: null, grain_sale_limits: [], grain_carry_settings: null, grain_carry_grids: [],

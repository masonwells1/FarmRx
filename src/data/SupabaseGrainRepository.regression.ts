...
async function run() {
  ...
  await snapshotRepo.appendBinTransactionOperation({ id: uid(971), farm_id: snapshotData.fields.farm.id, grain_bin_id: snapshotData.grain_bins[0].id, direction: 'in', bushels: 25, commodity_id: snapshotGateway.state.scope.commodity_id, occurred_on: '2026-07-12', note: null, source_kind: null, crop_year: null, grain_load_id: null, created_at: stamp }, operationContext(snapshotData.fields.farm.id))
  ...
  const queuedMovement: BinTransaction = { id: uid(62), farm_id: data.fields.farm.id, grain_bin_id: data.grain_bins[0].id, direction: 'in', bushels: 25, commodity_id: data.fields.commodities[0].id, occurred_on: '2026-07-12', note: null, source_kind: 'manual entry', crop_year: null, grain_load_id: null, created_at: stamp }
  ...
  const movement: BinTransaction = { id: uid(992), farm_id: uid(88), grain_bin_id: savedBin.id, direction: 'in', bushels: 25, commodity_id: gateway.state.scope.commodity_id, occurred_on: '2026-07-12', note: 'Scale ticket', source_kind: 'manual entry', crop_year: null, grain_load_id: null, created_at: stamp }
  ...
  const ambiguousMovement: BinTransaction = { id: uid(1191), farm_id: ambiguousMovementGateway.state.fields.farm.id, grain_bin_id: String((ambiguousMovementGateway.state.bundle.grain_bins[0] as { id: string }).id), direction: 'in', bushels: 17, commodity_id: ambiguousMovementGateway.state.scope.commodity_id, occurred_on: '2026-07-12', note: 'Ambiguous legacy replay', source_kind: 'manual entry', crop_year: null, grain_load_id: null, created_at: stamp }
